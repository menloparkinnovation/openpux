...
12/22/2015 - last update for RaspberryPi2 with ArmV7

Setup information and scripts for RaspberryPi2.

This configures the RaspberryPi2 Raspian distribution as a "headless"
...
It also has the software preloaded to support the RaspberryPi official touch
display.
...
// RaspberryPi setup:
 ...
 - install node.js
   - It's got its own section in nodejs/setup.txt
...
Note: See openpux/setup.txt for automatic start/stop with /etc/init.d
