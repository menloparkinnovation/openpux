...
//
// From https://github.com/esquiloio/lib/blob/master/demos/weather/angular/weather.js
// 10/19/2015
//
// Updates "/erpc" to application specific "/weather/erpc" since the openpux
...
app.controller('MainController',['$scope', '$http',
    function($scope, $http) {
        ...
        function getWeather() {
            ...
            $http.post('/esquiloio/weather/erpc', {method:'getWeather'}).
