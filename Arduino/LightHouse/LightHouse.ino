...
//
LightHouseHardware g_lightHouseHardware;
...
ApplicationSetup()
{
  ...
  g_lightHouseHardware.Initialize(
      &light,
      &sensors
      );
  ...
  // uses NMEA 0183 streaming sensors for environmental conditions.
  //
  g_lightHouseHardware.SetDweet(g_sensorApp.GetDweet());
