...
//
// Menlo: 12/28/2013
// Insure all loops keep the watchdog reset/posted
//
#include <avr/wdt.h>
...
{
	while (!waitSlaveSign()) wdt_reset(); // Menlo: watchdog
}

void SpiDrv::waitForSlaveReady()
{
        while (!waitSlaveReady()) wdt_reset(); // Menlo: watchdog
}
