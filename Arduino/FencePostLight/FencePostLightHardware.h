...
/*
 *  Date: 02/10/2015
 *  File: FencePostLightHardware.h
 *
 * Hardware handling for FencePostLight
 *
 * The FencePostLight provides 3 color LED and environmental
 * and battery monitoring.
 *
 */

#ifndef FencePostLightHardware_h
#define FencePostLightHardware_h
...
//
// The existing LightHouse library is used to the light sequence
// used in the FencePostLight.
//
// FencePostLigthHardware is a slave to LightHouseApp which handles
...
// readings are done.
//
class FencePostLightHardware : public LightHouseHardwareBase {

public:

    FencePostLightHardware();
    ...
    // Get sensor readings
    //
    // Note: our sensor readings are a subset of the full
    // lighthouse ones. In the case of FencePostLight is ambient
    // light and optional temperature.
    //
...
#endif // FencePostLightHardware_h
